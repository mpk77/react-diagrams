...
import demo_cust_nodes from './demos/diamond';
...
import silverWorkView from './demos/silver-workview';

storiesOf('Silver Work View', module)
	.add('Components Demo', silverWorkView)
